...
class OperatorNotificationPage extends StatefulWidget {
  ...
  const OperatorNotificationPage({Key? key, required this.user}) : super(key: key);

  @override
  State<OperatorNotificationPage> createState() => _OperatorNotificationPageState();
}
...
class _OperatorNotificationPageState extends State<OperatorNotificationPage> {
  ...
  Future<void> _loadNotifications() async {
    ...
    try {
      final notifications = await _dbService.getOperatorNotifications(widget.user.username);
      setState(() {
  ...
  Future<void> _markAsRead(String entryId) async {
    await _dbService.markOperatorNoteAsRead(entryId);
    setState(() {
            ...
            TextButton(
              onPressed: () async {
                for (var n in _notifications) {
                  await _dbService.markOperatorNoteAsRead(n.id);
                }
                _loadNotifications();
              },
              child: const Text(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                notification.operatorNote ?? 'Tidak ada pesan',
